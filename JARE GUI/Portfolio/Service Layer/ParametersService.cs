    ...
    public class ParametersService
    {
        ...
        public void LoadParametersFromFile(Parameters parameters, string fileName)
        {
            ...
            try
            {
                ...
                else parameters.OptimizationEvaluationCriteria1.CriteriaType = EvaluationCriteriaReturnBased.criteriaType.none;
                ...
                else parameters.OptimizationEvaluationCriteria2.CriteriaType = EvaluationCriteriaReturnBased.criteriaType.none;
                ...
                else parameters.OptimizationEvaluationCriteria3.CriteriaType = EvaluationCriteriaCreditExposureBased.criteriaType.none;
                if (parametersDict.ContainsKey("Fitness criteria 4")) parameters.OptimizationEvaluationCriteria4.CriteriaType = (EvaluationCriteriaParameterBased.criteriaType)GetIntegerFromString(parametersDict["Fitness criteria 4"]);
                else parameters.OptimizationEvaluationCriteria4.CriteriaType = EvaluationCriteriaParameterBased.criteriaType.none;
                if (parametersDict.ContainsKey("Fitness criteria 5")) parameters.OptimizationEvaluationCriteria5.CriteriaType = (EvaluationCriteriaParameterBased.criteriaType)GetIntegerFromString(parametersDict["Fitness criteria 5"]);
                else parameters.OptimizationEvaluationCriteria5.CriteriaType = EvaluationCriteriaParameterBased.criteriaType.none;
        ...
        public void SaveParametersToFile(Parameters parameters, string fileName)
        {
            try
            {
                ...
                sw.WriteLine("Fitness criteria 4" + "," + ((int)parameters.OptimizationEvaluationCriteria4.CriteriaType).ToString());
                sw.WriteLine("Fitness criteria 5" + "," + ((int)parameters.OptimizationEvaluationCriteria5.CriteriaType).ToString());
