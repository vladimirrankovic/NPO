...
namespace JARE.problems.ZDT
{
	...
	/// <summary> Class representing problem ZDT3</summary>
	[Serializable]
	public class ZDT3:Problem
	{
		...
		/// </param>
		public ZDT3(System.String solutionType):this(solutionType, 30)
		...
		public ZDT3(System.String solutionType, System.Int32 numberOfVariables)
		{
		...
		/// <summary> Returns the value of the ZDT2 function G.</summary>
		...
		/// <summary> Returns the value of the ZDT3 function H.</summary>
		...
		{
			double h = 0.0;
			h = 1.0 - System.Math.Sqrt(f / g) - (f / g) * System.Math.Sin(10.0 * System.Math.PI * f);
			return h;
		} //evalH
	} // ZDT3
}