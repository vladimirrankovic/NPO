...
namespace JARE.problems.DTLZ
{
	...
	/// <summary> Class representing problem DTLZ3</summary>
	[Serializable]
	public class DTLZ3:Problem
	{
		
		/// <summary> Creates a default DTLZ3 problem (12 variables and 3 objectives)</summary>
		/// <param name="solutionType">The solution type must "Real" or "BinaryReal". 
		/// </param>
		public DTLZ3(System.String solutionType):this(solutionType, 12, 3)
		{
		} // DTLZ3
		
		/// <summary> Creates a new DTLZ3 problem instance</summary>
		...
		public DTLZ3(System.String solutionType, System.Int32 numberOfVariables, System.Int32 numberOfObjectives)
		{
