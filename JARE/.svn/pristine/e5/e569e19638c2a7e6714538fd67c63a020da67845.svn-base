...
using PrintOperatorsInfo = jmetal.gui.utils.PrintOperatorsInfo;
namespace jmetal.gui.operators
{
	...
	public class AddOperator
	{
		...
		{
			public AnonymousClassActionListener(AddOperator enclosingInstance)
			{
				InitBlock(enclosingInstance);
			}
			private void  InitBlock(AddOperator enclosingInstance)
			{
				this.enclosingInstance = enclosingInstance;
			}
			private AddOperator enclosingInstance;
			public AddOperator Enclosing_Instance
			{
				get
				{
		...
		{
			public AnonymousClassActionListener1(AddOperator enclosingInstance)
			{
				InitBlock(enclosingInstance);
			}
			private void  InitBlock(AddOperator enclosingInstance)
			...
			public virtual void  actionPerformed(System.Object event_sender, System.EventArgs e)
			{
				try
				{
					(new PrintOperatorsInfo()).printOperatorInfo(Enclosing_Instance.algorithmName_.Text, Enclosing_Instance.packageName_.Text);
				}
		...
		public virtual void  actionPerformed(System.Object event_sender, System.EventArgs e)
		{
			...
			temp_label2.Text = "Operator Name";
