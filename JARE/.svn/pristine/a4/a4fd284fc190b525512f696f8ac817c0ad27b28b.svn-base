...
namespace JARE.problems.cec2009Competition
{
	...
	/// <summary> Class representing problem CEC2009_UF3</summary>
	[Serializable]
	public class CEC2009_UF3:Problem
	{
		...
		/// </param>
		public CEC2009_UF3(System.String solutionType):this(solutionType, 30)
		{ // 30 variables by default
		} // CEC2009_UF3
		
		/// <summary> Creates a new instance of problem CEC2009_UF3.</summary>
		/// <param name="numberOfVariables">Number of variables.
		/// </param>
		/// <param name="solutionType">The solution type must "Real" or "BinaryReal".
		/// </param>
		//UPGRADE_NOTE: ref keyword was added to struct-type parameters. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1303'"
		public CEC2009_UF3(System.String solutionType, System.Int32 numberOfVariables)
		{
			m_numberOfVariables = numberOfVariables;
			m_numberOfObjectives = 2;
			m_numberOfConstraints = 0;
			m_problemName = "CEC2009_UF3";
		...
		public override void  evaluate(Solution solution)
		{
			...
			{
				yj = x[j - 1] - System.Math.Pow(x[0], 0.5 * (1.0 + 3.0 * (j - 2.0) / (m_numberOfVariables - 2.0)));
				pj = System.Math.Cos(20.0 * yj * System.Math.PI / System.Math.Sqrt(j));
				if (j % 2 == 0)
				{
					sum2 += yj * yj;
					prod2 *= pj;
			...
			solution.setObjective(1, 1.0 - System.Math.Sqrt(x[0]) + 2.0 * (4.0 * sum2 - 2.0 * prod2 + 2.0) / (double) count2);
		} // evaluate
	} // CEC2009_UF3
}