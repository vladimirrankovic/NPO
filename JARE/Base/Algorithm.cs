...
namespace JARE.Base
{
	...
	public abstract class Algorithm
	{
        ...
        /// </summary>
        public virtual void deleteOperators()
        {
            if(m_operators != null) m_operators.Clear();
        } // deleteOperators
        
        /// <summary> Delete input parameters.
        /// </summary>
        public virtual void deleteInputParameters()
        {
            if(m_inputParameters != null) m_inputParameters.Clear();
        } // deleteOperators 
        
        /// <summary> Delete output parameters.
        /// </summary>
        public virtual void deleteOutputParameters()
        {
            if(m_outPutParameters != null) m_outPutParameters.Clear();
        } // deleteOperators 
