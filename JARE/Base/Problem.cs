...
namespace JARE.Base
{
	...
	public abstract class Problem
	{
        ...
        public virtual void PrintGenerationReport(SolutionSet population, Solution bestSolution, int genNO) {}
        public SolutionSet ReadStartingPopulation(string file) { return null; } //Slavisa dodao zbog builda
        protected System.IO.DirectoryInfo m_directory;
        protected System.IO.DirectoryInfo m_subdirectory;

        //Slavisa
        public virtual void CreateAlgorithmInfo(AlgorithmInfo algorithmInfo) { }
        public virtual void CreateAlgorithmInfoNew(AlgorithmInfo algorithmInfo) { }
