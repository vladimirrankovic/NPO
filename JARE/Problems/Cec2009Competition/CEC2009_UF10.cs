...
namespace JARE.problems.cec2009Competition
{
	...
	/// <summary> Class representing problem CEC2009_UF10</summary>
	[Serializable]
	public class CEC2009_UF10:Problem
	{
		...
		/// </param>
		public CEC2009_UF10(System.String solutionType):this(solutionType, 30)
		{ // 30 variables by default
		} // CEC2009_UF10
		
		/// <summary> Creates a new instance of problem CEC2009_UF10.</summary>
		/// <param name="numberOfVariables">Number of variables.
		/// </param>
		/// <param name="solutionType">The solution type must "Real" or "BinaryReal".
		/// </param>
		//UPGRADE_NOTE: ref keyword was added to struct-type parameters. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1303'"
		public CEC2009_UF10(System.String solutionType, System.Int32 numberOfVariables)
		{
			m_numberOfVariables = numberOfVariables;
			m_numberOfObjectives = 3;
			m_numberOfConstraints = 0;
			m_problemName = "CEC2009_UF10";
		...
		public override void  evaluate(Solution solution)
		{
			...
			for (int j = 3; j <= m_numberOfVariables; j++)
			{
				...
				hj = 4.0 * yj * yj - System.Math.Cos(8.0 * System.Math.PI * yj) + 1.0;
				if (j % 3 == 1)
				{
					sum1 += hj;
					count1++;
