...
namespace JARE.problems.cec2009Competition
{
	...
	[Serializable]
	public class CEC2009_UF6:Problem
	{
		internal int m_N;
		...
		/// </param>
		public CEC2009_UF6(System.String solutionType):this(solutionType, 30, 2, 0.1)
		{ // 30 variables, N =10, epsilon = 0.1
		} // CEC2009_UF1
		
		/// <summary> Creates a new instance of problem CEC2009_UF6.</summary>
		/// <param name="numberOfVariables">Number of variables.
		/// </param>
		/// <param name="solutionType">The solution type must "Real" or "BinaryReal".
		/// </param>
		//UPGRADE_NOTE: ref keyword was added to struct-type parameters. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1303'"
		public CEC2009_UF6(System.String solutionType, System.Int32 numberOfVariables, int N, double epsilon)
		{
			m_numberOfVariables = numberOfVariables;
			m_numberOfObjectives = 2;
			m_numberOfConstraints = 0;
			m_problemName = "CEC2009_UF6";
		...
		public override void  evaluate(Solution solution)
		{
			...
			hj = 2.0 * (0.5 / m_N + m_epsilon) * System.Math.Sin(2.0 * m_N * System.Math.PI * x[0]);
			if (hj < 0.0)
				hj = 0.0;
