...
namespace JARE.problems.DTLZ
{
	...
	/// <summary> Class representing problem DTLZ6</summary>
	[Serializable]
	public class DTLZ6:Problem
	{
		
		/// <summary> Creates a default DTLZ6 problem instance (12 variables and 3 objectives)</summary>
		/// <param name="solutionType">The solution type must "Real" or "BinaryReal". 
		/// </param>
		public DTLZ6(System.String solutionType):this(solutionType, 12, 3)
		{
		} // DTLZ6
		
		/// <summary> Creates a new DTLZ6 problem instance</summary>
		...
		public DTLZ6(System.String solutionType, System.Int32 numberOfVariables, System.Int32 numberOfObjectives)
		{
		...
		public override void  evaluate(Solution solution)
		{
			...
			for (int i = m_numberOfVariables - k; i < m_numberOfVariables; i++)
				g += System.Math.Pow(x[i], 0.1);
			
			double t = System.Math.PI / (4.0 * (1.0 + g));
			theta[0] = x[0] * System.Math.PI / 2;
