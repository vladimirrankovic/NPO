...
namespace JARE.problems.DTLZ
{
	...
	/// <summary> Class representing problem DTLZ4</summary>
	[Serializable]
	public class DTLZ4:Problem
	{
		
		
		/// <summary> Creates a default DTLZ4 problem (12 variables and 3 objectives) </summary>
		/// <param name="solutionType">The solution type must "Real" or "BinaryReal". 
		/// </param>
		public DTLZ4(System.String solutionType):this(solutionType, 12, 3)
		{
		}
		
		/// <summary> Creates a DTLZ4 problem problem instance </summary>
		...
		public DTLZ4(System.String solutionType, System.Int32 numberOfVariables, System.Int32 numberOfObjectives)
		{
		...
		public override void  evaluate(Solution solution)
		{
			...
			for (int i = 0; i < m_numberOfObjectives; i++)
			{
				for (int j = 0; j < m_numberOfObjectives - (i + 1); j++)
					f[i] *= System.Math.Cos(System.Math.Pow(x[j], alpha) * (System.Math.PI / 2.0));
				if (i != 0)
				{
					int aux = m_numberOfObjectives - (i + 1);
					f[i] *= System.Math.Sin(System.Math.Pow(x[aux], alpha) * (System.Math.PI / 2.0));
				} //if
			} // for
