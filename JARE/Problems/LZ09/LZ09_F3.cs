...
namespace JARE.problems.LZ09
{
	...
	/// <summary> Class representing problem LZ09_F3 </summary>
	[Serializable]
	public class LZ09_F3:Problem
	{
		internal LZ09 m_LZ09;
		/// <summary> Creates a default LZ09_F3 problem (30 variables and 2 objectives)</summary>
		/// <param name="solutionType">The solution type must "Real" or "BinaryReal". 
		/// </param>
		public LZ09_F3(System.String solutionType):this(solutionType, 21, 1, 23)
		{
		} // LZ09_F3
		
		/// <summary> Creates a LZ09_F3 problem instance</summary>
		/// <param name="solutionType">The solution type must "Real" or "BinaryReal". 
		/// </param>
		//UPGRADE_NOTE: ref keyword was added to struct-type parameters. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1303'"
		public LZ09_F3(System.String solutionType, System.Int32 ptype, System.Int32 dtype, System.Int32 ltype)
		{
			m_numberOfVariables = 30;
			m_numberOfObjectives = 2;
			m_numberOfConstraints = 0;
			m_problemName = "LZ09_F3";
