...
namespace JARE.problems.LZ09
{
	...
	/// <summary> Class representing problem LZ09_F6 </summary>
	[Serializable]
	public class LZ09_F6:Problem
	{
		internal LZ09 m_LZ09;
		/// <summary> Creates a default LZ09_F6 problem (30 variables and 2 objectives)</summary>
		/// <param name="solutionType">The solution type must "Real" or "BinaryReal". 
		/// </param>
		public LZ09_F6(System.String solutionType):this(solutionType, 31, 1, 32)
		{
		} // LZ09_F6
		
		/// <summary> Creates a LZ09_F6 problem instance</summary>
		/// <param name="solutionType">The solution type must "Real" or "BinaryReal". 
		/// </param>
		//UPGRADE_NOTE: ref keyword was added to struct-type parameters. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1303'"
		public LZ09_F6(System.String solutionType, System.Int32 ptype, System.Int32 dtype, System.Int32 ltype)
		{
			m_numberOfVariables = 10;
			m_numberOfObjectives = 3;
			m_numberOfConstraints = 0;
			m_problemName = "LZ09_F6";
			...
			m_lowerLimit[1] = 0.0;
			m_upperLimit[1] = 1.0;
			for (int var = 2; var < m_numberOfVariables; var++)
			{
				m_lowerLimit[var] = - 2.0;
				m_upperLimit[var] = 2.0;
			} //for
