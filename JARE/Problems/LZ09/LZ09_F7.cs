...
namespace JARE.problems.LZ09
{
	...
	/// <summary> Class representing problem LZ09_F7 </summary>
	[Serializable]
	public class LZ09_F7:Problem
	{
		internal LZ09 m_LZ09;
		/// <summary> Creates a default LZ09_F7 problem (10 variables and 2 objectives)</summary>
		/// <param name="solutionType">The solution type must "Real" or "BinaryReal". 
		/// </param>
		public LZ09_F7(System.String solutionType):this(solutionType, 21, 3, 21)
		{
		} // LZ09_F7
		
		/// <summary> Creates a LZ09_F7 problem instance</summary>
		...
		public LZ09_F7(System.String solutionType, System.Int32 ptype, System.Int32 dtype, System.Int32 ltype)
		{
			m_numberOfVariables = 10;
			m_numberOfObjectives = 2;
			m_numberOfConstraints = 0;
			m_problemName = "LZ09_F7";
