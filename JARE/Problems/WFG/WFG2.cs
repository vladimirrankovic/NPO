...
namespace JARE.problems.WFG
{
	...
	/// <summary> This class implements the WFG2 problem
	...
	public class WFG2:WFG
	{
		...
		/// <summary> Creates a default WFG2 instance with 
		...
		/// </param>
		public WFG2(System.String solutionType):this(solutionType, 2, 4, 2)
		{
		} // WFG2
		
		/// <summary> Creates a WFG2 problem instance</summary>
		...
		public WFG2(System.String solutionType, System.Int32 k, System.Int32 l, System.Int32 M):base(solutionType, k, l, M)
		{
			m_problemName = "WFG2";
        ...
        public override float[] evaluate(float[] z)
		{
			...
			result[m_M - 1] = m_D * x[m_M - 1] + m_S[m_M - 1] * (new Shapes()).disc(x, 5, (float) 1.0, (float) 1.0);
			
			return result;
		} // evaluate
		
		
		/// <summary> WFG2 t1 transformation</summary>
		...
		/// <summary> WFG2 t2 transformation</summary>
		...
		/// <summary> WFG2 t3 transformation</summary>
