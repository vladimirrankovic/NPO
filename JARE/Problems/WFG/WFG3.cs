...
namespace JARE.problems.WFG
{
	...
	/// <summary> This class implements the WFG3 problem
	...
	public class WFG3:WFG
	{
		...
		/// <summary> Creates a default WFG3 instances with 
		...
		/// </param>
		public WFG3(System.String solutionType):this(solutionType, 2, 4, 2)
		{
		} // WFG3
		
		/// <summary> Creates a WFG3 problem instance</summary>
		...
		public WFG3(System.String solutionType, System.Int32 k, System.Int32 l, System.Int32 M):base(solutionType, k, l, M)
		{
			m_problemName = "WFG3";
        ...
        public override float[] evaluate(float[] z)
		{
			...
			for (int m = 1; m <= m_M; m++)
			{
				result[m - 1] = m_D * x[m_M - 1] + m_S[m - 1] * (new Shapes()).linear(x, m);
			}
			
			return result;
		} // evaluate
		
		/// <summary> WFG3 t1 transformation</summary>
		...
		/// <summary> WFG3 t2 transformation</summary>
		...
		/// <summary> WFG3 t3 transformation</summary>
