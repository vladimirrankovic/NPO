...
namespace JARE.problems.WFG
{
	...
	/// <summary> Creates a default WFG9 problem with 
	...
	public class WFG9:WFG
	{
		...
		/// <summary> Creates a default WFG9 with 
		/// 2 position-related parameters, 
		/// 4 distance-related parameters,
		/// and 2 objectives
		/// </summary>
		/// <param name="solutionType">The solution type must "Real" or "BinaryReal".
		/// </param>
		public WFG9(System.String solutionType):this(solutionType, 2, 4, 2)
		{
		} // WFG9
		
		/// <summary> Creates a WFG9 problem instance</summary>
		/// <param name="k">Number of position variables
		/// </param>
		/// <param name="l">Number of distance variables
		/// </param>
		...
		public WFG9(System.String solutionType, System.Int32 k, System.Int32 l, System.Int32 M):base(solutionType, k, l, M)
		{
			m_problemName = "WFG9";
		...
		/// <summary> WFG9 t1 transformation</summary>
		...
		/// <summary> WFG9 t2 transformation</summary>
		...
		/// <summary> WFG9 t3 transformation</summary>
		...
		{
			float[] variables = new float[this.NumberOfVariables];
