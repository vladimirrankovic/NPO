/// <summary> Permutation.java </summary>
...
namespace JARE.util
{
	...
	/// <summary> Class that provide an int permutation</summary>
	public class PermutationUtility
	{
		
		/// <summary> Returns a permutation vector between the 0 and (length - 1) </summary>
