...
namespace jmetal.gui.components.algorithms
{
	...
	public class AddAlgorithm
	{
		...
		{
			public AnonymousClassActionListener(AddAlgorithm enclosingInstance)
			{
				InitBlock(enclosingInstance);
			}
			private void  InitBlock(AddAlgorithm enclosingInstance)
			{
				this.enclosingInstance = enclosingInstance;
			}
			private AddAlgorithm enclosingInstance;
			public AddAlgorithm Enclosing_Instance
			{
				get
				{
		...
		{
			public AnonymousClassActionListener1(AddAlgorithm enclosingInstance)
			{
				InitBlock(enclosingInstance);
			}
			private void  InitBlock(AddAlgorithm enclosingInstance)
			...
			public virtual void  actionPerformed(System.Object event_sender, System.EventArgs e)
			{
				try
				{
					(new PrintAlgorithmsInfo()).printAlgorithmInfo(Enclosing_Instance.algorithmName_.Text, Enclosing_Instance.packageName_.Text);
					//panel_.addAlgorithm();
				}
		...
		public virtual void  actionPerformed(System.Object event_sender, System.EventArgs e)
		{
			...
			temp_label2.Text = "Algorithm Name";
