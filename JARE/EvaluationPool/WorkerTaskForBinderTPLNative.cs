...
namespace JARE.EvaluationPool
{
	public class WorkerTaskForBinderTPLNative
	{
		...
		StreamWriter sw;
		EvaluationResult er;
        BinderClientCSharp.JavaProperties properties;
		//Djordje dodao
		...
		public WorkerTaskForBinderTPLNative(string script, string varFile, string dir, int numOfResults, int procTimeout, BinderClientCSharp.JavaProperties properties)
		{
			this.dir = dir;
			this.script = script;
			this.numOfResults = numOfResults;
		...
		public EvaluationResult ExecuteScript(Solution solution)
		{
			...
			try
			{
                ...
                BinderClientCSharp.ClientR ce = new BinderClientCSharp.ClientR(parameters, properties);
