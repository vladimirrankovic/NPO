...
{
    public class NSGAIIFMixedExecution : Algorithm
    {
        ...
        public NSGAIIFMixedExecution(Problem problem, string script, string dir, 
        ...
        public override SolutionSet execute()
        {
            ...
            //VLADA - Evaluacija po ciljnim funkcijama koje se evaluiraju single thread
            for (int i = 0; i < populationSize; i++)
            {
                m_problem.evaluate(population.m_solutionsList[i]);
            } //for
            ...
            while (evaluations < maxEvaluations)
            {
                ...
                int iterationCount;
                if ((maxEvaluations - evaluations) > offspringPopulation.size()) iterationCount = offspringPopulation.size();
                else iterationCount = maxEvaluations - evaluations;
                //Evaluation via Binder
