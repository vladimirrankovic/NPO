...
namespace JARE.metaheuristics.nsgaII
{
    ...
    [Serializable]
    public class NSGAIIEvalPool : Algorithm
    {
        ...
        /// </param>
        public NSGAIIEvalPool(Problem problem)
        {

            this.m_problem = problem;
            eps = new JARE.EvaluationPool.EvaluationPoolSequentional(m_problem);
        ...
        public override SolutionSet execute()
        {
            ...
            for (int i = 0; i < populationSize; i++)
            {
                ...
                brojPoslatih++;
                //m_problem.evaluateConstraints(population.m_solutionsList[i]);
                evaluations++;
            } //for 
            eps.Wait();
